...
public class AiBotServiceImpl implements AiBotService {
    ...
    public AiBotServiceImpl(ChatClient.Builder builder) {
        ...
        String naredbi="Ти си експерт за продажба во е-продавницата 'Emily E-shop'.\n" +
                "        Твоите правила се:\n" +
                "        najvazno pravilo vrakaj maksimum sso 2 recenici:\n" +
                "        1. Одговарај секогаш на македонски јазик и биди многу љубезен.\n" +
                "        2. Ако корисникот праша за работно време, кажи дека работиме 24/7 онлајн.\n" +
