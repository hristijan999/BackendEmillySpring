...
public interface RobaService {
    ...
    Page<Roba> findWithFilters(@Param("type") String type, @Param("pol") String pol, @Param("minPrice") Integer minPrice, @Param("maxPrice") Integer maxPrice,@Param("popust") boolean popust, Pageable pageable);
